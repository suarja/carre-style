          ...
          <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Du lundi au vendredi, 8h-19h</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Nous vous répondons sous 24h</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Zone d'intervention : Haut-Rhin et environs</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mt-1">Suivez nos dernières réalisations</p>
                  </div>
                </div>
              </div>

              <div className="mt-8">
                <h3 className="font-semibold text-lg mb-4">Notre zone d'intervention</h3>
            ...
            <div id="devis">
              <div className="bg-cs-dark-lighter p-8 rounded-lg shadow-md border border-gray-800">
                <h2 className="text-2xl font-bold mb-6 text-white">Demande de devis gratuit</h2>
                <ContactForm />
              </div>
            </div>
          </div>
